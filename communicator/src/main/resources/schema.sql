...
CREATE TABLE MEMBER_CONVERSATIONS (
    ...
    CONSTRAINT MEMBER_REF_MC FOREIGN KEY(member_id) REFERENCES MEMBER(id) ON DELETE CASCADE,
    CONSTRAINT CONV_REF_MC FOREIGN KEY(conversation_id) REFERENCES CONVERSATION(id) ON DELETE CASCADE
);